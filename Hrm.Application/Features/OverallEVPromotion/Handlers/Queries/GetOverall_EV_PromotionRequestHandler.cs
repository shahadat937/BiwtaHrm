...
namespace Hrm.Application.Features.Overall_EV_Promotion.Handlers.Queries
{
    public class GetOverall_EV_PromotionRequestHandler : IRequestHandler<GetOverall_EV_PromotionRequest, object>
    {
        ...
        public GetOverall_EV_PromotionRequestHandler(IHrmRepository<Hrm.Domain.OverallEVPromotion> Overall_EV_PromotionRepository, IMapper mapper)
        {
        ...
        public async Task<object> Handle(GetOverall_EV_PromotionRequest request, CancellationToken cancellationToken)
        {
            ...
            IQueryable<Hrm.Domain.OverallEVPromotion> Overall_EV_Promotions = _Overall_EV_PromotionRepository.Where(x => true);

            // Order blood groups by descending order
            Overall_EV_Promotions = Overall_EV_Promotions.OrderByDescending(x => x.OverallEVPromotionId);

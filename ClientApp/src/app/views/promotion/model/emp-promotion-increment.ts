export class EmpPromotionIncrement {
    ...
    applicationByDepartmentId: number | null = null;
    applicationBySectionId: number | null = null;
    applicationByDesignationId: number | null = null;
    applicationByResponsibityTypeId: number | null = null;

    approveByDepartmentId: number | null = null;
    approveBySectionId: number | null = null;
    approveByDesignationId: number | null = null;
    approveByResponsibityTypeId: number | null = null;
}

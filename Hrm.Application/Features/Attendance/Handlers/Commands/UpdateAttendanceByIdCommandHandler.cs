...
{
    public class UpdateAttendanceByIdCommandHandler: IRequestHandler<UpdateAttendanceByIdCommand, BaseCommandResponse>
    {
        ...
        public async Task<BaseCommandResponse> Handle(UpdateAttendanceByIdCommand request, CancellationToken cancellationToken)
        {
            ...
            var Attendance = await _AttendanceRepository.Get(request.Attendancedto.AttendanceId);

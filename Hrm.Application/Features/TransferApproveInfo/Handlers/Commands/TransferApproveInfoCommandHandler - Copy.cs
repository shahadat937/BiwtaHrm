...
{
    public class TransferApproveInfoCommandHandler : IRequestHandler<CreateTransferApproveInfoCommand, BaseCommandResponse>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;
        public TransferApproveInfoCommandHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
